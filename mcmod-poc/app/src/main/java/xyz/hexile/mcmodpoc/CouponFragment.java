...
public class CouponFragment extends Fragment {
    ...
    private void updateRegistrationBody(String id, TextView textView) {
        couponBody = Utils.couponBody(id);
        textView.setText(couponBody);
    }
    ...
    private Request emailRegistrationRequest() {
        RequestBody body = RequestBody.create(MediaType.parse("application/json"), couponBody);
        Request.Builder requestBuilder = new Request.Builder()
                ...
                .url("https://dif-dot-prd-euw-gmal-mcdonalds.appspot.com/plexure/v1/con/v3/consumers/redeemedOffers")
                .post(body);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // Coupon ID EditText
        EditText couponEdit = new EditText(context);
        couponEdit.setLayoutParams(LayoutUtils.MATCH_WRAP);
        couponEdit.setHint("Coupon ID");

        // Coupon Body TextView
        TextView couponBodyTextView = new TextView(context);
        smallTextView(couponBodyTextView);
        couponBodyTextView.setText("Registration Body");
        ...
        emailRegistrationButton.setText("3) Redeem Coupon");
        ...
        safetyNetButton.setOnClickListener(v -> {
            ...
            date = Utils.getDate();
            digest = Utils.digestSha256(couponBody);

            String data = "(request-target): post /plexure/v1/con/v3/consumers/redeemedOffers\n" +
                    "host: dif-dot-prd-euw-gmal-mcdonalds.appspot.com\n" +
                    "date: " + date + "\n" +
                    "authorization: bearer " + authorization + "\n" +
                    "digest: SHA-256=" + digest + "\n" +
                    "content-length: " + couponBody.length();
        ...
        emailRegistrationButton.setOnClickListener(v -> {
            ProgressDialog progressDialog = new ProgressDialog(context);
            progressDialog.setTitle("Coupon Redeem");
            progressDialog.setMessage("Loading...");
            progressDialog.setCancelable(false);
            progressDialog.show();
        ...
        couponEdit.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                updateRegistrationBody(s.toString(), couponBodyTextView);
            }
        ...
        mainLayout.addView(couponEdit);
        mainLayout.addView(couponBodyTextView);
